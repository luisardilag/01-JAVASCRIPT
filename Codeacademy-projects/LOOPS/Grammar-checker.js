...
let index = storyWords.findIndex(word => word.length > 10);
console.log(storyWords[index]);

storyWords[index] = "PEPETRUENO";

console.log(storyWords);


/* CONCLUSIONES:
* Se USARON los métodos de arrays: forEach, filter, map, findIndex, every.
* Se USÓ el método split para convertir un string en un array.
* Se USÓ el método join para convertir un array en un string.
*/